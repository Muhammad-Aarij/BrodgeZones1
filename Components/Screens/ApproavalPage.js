                ...
                <View style={styles.maincontainer}>
                    ...
                    <View style={styles.btncontainer}>
                        <TouchableOpacity
                            style={[
                                styles.btn,
                                { backgroundColor: "#de3e1e", width: width * 0.3 },
...
const styles = StyleSheet.create({
    ...
    disabledBtn: {
        backgroundColor: 'gray', // Change to your desired disabled background color
        opacity: 0.6, // Adjust opacity to make the button appear disabled
    },
});
